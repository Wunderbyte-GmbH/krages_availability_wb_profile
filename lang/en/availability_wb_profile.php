...
$string['pluginname'] = 'Restriction by profile wb extended';
...
$string['requires_isgreater'] = 'Your <strong>{$a->field}</strong> is greater <strong>{$a->value}</strong>';
$string['requires_issmaller'] = 'Your <strong>{$a->field}</strong> is smaller <strong>{$a->value}</strong>';
$string['requires_comparestotimestring'] = 'Your <strong>{$a->field}</strong> fails on <strong>{$a->value}</strong>';
...
$string['op_isgreater'] = 'is greater';
$string['op_issmaller'] = 'is smaller';
$string['op_comparestotimestring'] = 'compares to time string';
